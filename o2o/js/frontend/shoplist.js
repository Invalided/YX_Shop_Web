...
$(function() {
	...
	var pageSize = 3;
	// 获取店铺列表的URL
	var listUrl = server + '/o2o/frontend/listshops';
	// 获取店铺类别列表以及区域列表的URL
	var searchDivUrl = server + '/o2o/frontend/listshopspageinfo';
	// 页码
	var pageNum = 1;
			...
			if (data.success) {
				...
				data.shopList.map(function(item, index) {
					html += '' + '<div class="card" data-shop-id="'
							...
							+ server + item.shopImg + '" width="44">' + '</div>'
	...
	$('.shop-list').on('click', '.card', function(e) {
		...
		window.location.href = server + '/o2o/frontend/shopdetail?shopId=' + shopId;
	});
